...
CreditsSection4:AddLabel("discord.gg/sourpatch")
CreditsSection4:AddButton({
    text = "Copy Invite",
    callback = function()
        setclipboard("https://discord.gg/sourpatch")
    end,
})
...
CreditsSection:AddLabel("Made by: edx#1337")
...
client:console("Space X Soft Aim for more" .. tostring(tick() - start) .. "ms")
